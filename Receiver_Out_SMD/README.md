...
The "Receiver Out SMD" ia a 4 port Differental Reciver output board for the PB16. This design is surface mount based and is harder to solder. All the design files are open source and available on github.
